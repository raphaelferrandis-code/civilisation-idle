...
const PROPS = [
  ...
  {
    key: 'market-macellum',
    // band 4 (Marbre / toges) — ÉTAL romain ouvert (velum rayé + comptoir de marchandises),
    // HIGH top-down (112×96). Remplace le repli procédural de la branche `if (band === 4)`.
    // v3 2026-07-12 = ÉTAL ouvert SANS mur (demande Raph « un mur c'est bizarre, il faut une étale »).
    //   v1 c7c12dfe = trop temple ; v2 e2fe9b95 = halle à mur de fond (rejeté).
    // Réglages « peu de teintes » : shading BASIC + palette limitée + quantize @16.
    id: 'c2181115-35cb-4d5b-96bd-5eea40ee19ce',
    shading: 'basic shading', quantize: 16,
    prompt: 'a small ancient Roman open-air market stall seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person, NOT a building, no walls, no enclosed hall, no back wall, fully open on all sides: a striped crimson-and-cream cloth awning velum stretched on slender marble posts over long wooden counter tables, the counters heaped with colorful goods — red apples, oranges, green vegetables, round loaves of bread, terracotta amphorae, folded cloth bolts — a couple of woven baskets and clay pots on the stone ground beside it, standing on a small stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, terracotta, crimson awning, warm goods colors), flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background',
  },
  {
  ...
  { key: 'sewers-medieval', id: '4836fd0c-8fb5-491d-bc81-6c54829047fa', shading: 'basic shading', quantize: 24, prompt: 'a small clean medieval stone waterworks and sewer drainage house seen from a high top-down angle, no people: neatly dressed grey stone building with a red terracotta tiled gabled roof and a small chimney, front pierced by a low round stone archway closed by a sturdy IRON GRATE with a shallow stone channel of clear running water flowing out into a gutter, a wooden sluice gate lever beside it, clean masonry with only a little moss at the waterline, warm earthy grey-stone and terracotta, basic flat shading, soft light from the upper-left, shadows to the lower-right, transparent background (112x88). v2 2026-07-13 (v1 3d50d082 = arche noire béante + mousse, « tunnel/ruine » rejeté par Raph)' },
  ...
  // Câblage : table RB4 (choke `if(band===4)`) dans cityEngineSprites.js / engineSprites.js ; port/mill = swap
  // du stageHouse ; caravane = sprite prêt mais NON câblé (véhicule animé à refaire). aqueducts/fields = déjà OK.
  { key: "granary-horreum-classical", id: "76985262-16b1-414e-a410-2e78a75e6c90", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman horreum grain warehouse seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a sturdy rectangular public granary of pale travertine and dressed marble ashlar blocks, its long front opened by a row of arched loading bays framed by short stone pilasters, a small columned portico with a low triangular pediment over the central doorway, thick buttressed side walls pierced by narrow high ventilation slits, the building raised on a low stone plinth above the ground for air circulation, a broad low-pitched roof of orderly red terracotta clay tiles with ridge caps, a couple of terracotta grain amphorae set beside the entrance, standing on a patch of pale flagstone paving, a LIMITED FLAT palette of only a few solid colors (warm travertine cream, pale marble grey, terracotta red-orange roof, ochre stone, shadow brown), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "scribes-tabularium", id: "2ff87668-f48d-4bbb-979c-cdb34e18647d", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman tabularium records archive and scriptorium seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a public records and scroll-copying hall of dressed travertine and white marble with a low-pitched terracotta tiled roof, a front arcade of round stone arches on square pillars, one open colonnaded portico wing sheltering a row of slanted wooden writing desks spread with unrolled papyrus scrolls and small inkpots, tall wooden armarium cabinets lined with pigeonhole cubbyholes stacked full of rolled scrolls (volumina), a woven basket and a clay amphora holding scrolls on the marble-paved floor beside them, a few marble entrance steps, a small carved pediment bearing an open-scroll-and-stylus emblem, standing on a small stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, travertine tan, terracotta roof tiles, warm parchment scrolls), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "storyteller-odeon", id: "04d55259-c247-4fad-b834-04f32ec93515", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman theatre and odeon seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a semicircular cavea of concentric tiered stone seating steps carved in pale travertine and cream marble, narrow radiating stairways splitting the tiers into wedges, a semicircular orchestra floor of patterned marble at the centre, closed on its flat side by a long rectangular stage building (scaenae frons) whose front is lined with a row of slender fluted marble columns beneath a low terracotta-tiled roof, dressed sandstone walls and a couple of arched vaulted entrances, standing on a small stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, pale travertine, terracotta roof tiles, warm sandy stone), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "schools-ludus", id: "ef995b0a-73e2-4d16-b0c7-864dcba24396", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman ludus schoolroom seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: an open columned portico schoolhouse under a low-pitched terracotta tiled roof carried on slender cream marble columns, NO enclosing walls, open on the front so the classroom floor is visible from above — a raised master's high-backed teacher's chair (cathedra) at one end, two short rows of plain wooden benches facing it, a low table strewn with folded wax writing tablets, a couple of rolled papyrus scrolls and a wooden abacus, the floor a simple pale mosaic-tiled stone patch, a modest triangular pediment over the entry, a LIMITED FLAT palette of only a few solid colors (cream travertine marble, warm terracotta roof tiles, brown wooden benches, a touch of ochre and crimson), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "caravan-oxcart-classical", id: "3de2f921-6483-4d71-bbae-1a798fd6ce9f", shading: 'basic shading', quantize: 16, view: 'side', prompt: "an ancient Roman merchant ox-cart, a loaded plaustrum, pulled by a pair of oxen, side view profile facing right, completely deserted, no people, no figures, no driver, no rider: a sturdy wooden Roman plaustrum freight cart with two solid heavy wooden disk wheels and a low railed cargo bed, the bed loaded with rows of terracotta amphorae and cloth-wrapped trade bales, a single curved wooden arch hoop rising over the load, harnessed by a plain wooden neck yoke and a straight draw-pole to two walking brown oxen side by side in front, weathered honey timber and warm terracotta clay with pale cream cloth, a LIMITED FLAT palette of only a few solid colors, basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "port-house-classical", id: "05437d4a-8ca4-4be2-ad8a-19b0375d5dd5", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman riverside harbor warehouse (horreum) seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a long low rectangular stone storehouse in cream travertine and brick-faced concrete with a red terracotta tiled gabled roof, a row of tall round loading arches along the front side facing the water, small high square ventilation windows, a short columned portico and a low stone quay ramp reaching down to the river edge, a few terracotta amphorae and wooden crates stacked beside the arched openings on the flagstones, a LIMITED FLAT palette of only a few solid colors (cream travertine stone, terracotta roof tiles, brick red, warm ochre), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background no ground" },
  { key: "guild-collegium", id: "3e77d4da-518e-43ad-a489-96a0fb4d0e71", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman craftsmen's collegium guild hall (schola collegii) seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a compact square travertine-and-brick building enclosing a small colonnaded inner courtyard, rows of slender pale marble columns forming a shaded portico around the open court, low terracotta-tiled sloping roofs seen from above around the courtyard, a round-arched entrance doorway flanked by stone pilasters at the front-center, a small stone aedicula shrine niche and a carved marble relief panel of crossed craftsmen's hammer and tongs above the door marking the trade guild, a squat brick forge chimney venting at the roof ridge, a couple of terracotta amphorae and an iron anvil set under the portico, standing on a small stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, travertine tan, terracotta-red roof tiles, warm ochre brick, iron-grey tools), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "mint-moneta", id: "e6741673-45c0-4c5a-93a1-69e210322f3a", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman mint workshop, the Moneta officina monetae seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a compact dressed-stone and cream-marble minting house with a short colonnaded portico of slender fluted columns and a low triangular pediment carved with a laurel-wreathed coin emblem, roofed in ridged terracotta tiles, its front open under the colonnade revealing the striking floor — a squat brick melting furnace with a small crucible glowing with orange embers for casting metal blanks, a heavy stone anvil bearing a round coin die, a wooden counter stacked with neat piles of freshly struck gold coins, and a few round coins scattered on the marble-paved ground beside a clay pot of blanks, standing on a small travertine-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, warm travertine tan, terracotta roof, gold coins, ember-orange forge glow), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "cult-vesta", id: "2f02fe20-82a1-4240-b94d-1ee5e9f1c9ab", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman round temple of Vesta seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a circular marble tholos shrine to the ancestors ringed by slender white fluted Corinthian columns supporting a low conical terracotta-tiled roof, raised on a stepped circular travertine podium, an open oculus center where a glowing eternal sacred flame burns on a round stone altar, a low marble parapet and a few small votive urns arranged around the ring, standing on a small stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream-white marble, terracotta roof, warm grey stone, glowing orange flame), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "academies-athenaeum", id: "baf48aa1-5707-4ae6-9684-6ac57b75c723", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman athenaeum, a school of higher learning and philosophy, seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: an open rectangular marble peristyle courtyard ringed by a colonnade of slender fluted marble columns carrying a low terracotta-tiled portico roof along the four edges, a curved semicircular exedra recess at the far side lined with a stone debate bench and a half-ring of small columns, an open paved inner court with a low marble plinth and a sundial at its center, a carved laurel-wreath emblem above the columned entrance, checkerboard cream-and-grey marble paving, fully open sides with no enclosing walls, dressed travertine and marble with terracotta roof tiles, a LIMITED FLAT palette of only a few solid colors (pale cream marble, travertine beige, terracotta roof tiles, laurel green, warm brown shadow), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "forager-hortus-classical", id: "1aea2501-65ca-4aeb-bf53-11a84c1c9576", shading: 'basic shading', quantize: 16, prompt: "a small open ancient Roman orchard garden plot seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person, NO walls, no fences, no enclosure, fully open on all sides: two or three neatly pruned fruit trees (fig and apple) with rounded olive-green canopies heavy with ripe red fruit, a low grapevine pergola trellis on slender wooden posts, several tall terracotta amphorae and round clay pots of soil, a couple of woven wicker baskets brimming with harvested fruit, and a small round stone water basin, arranged loosely on a small stone-paved and tended-earth patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (olive and forest green foliage, warm terracotta, cream stone, ripe red fruit), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "bank-basilica-roman", id: "44c814b2-a4b0-4c9c-baf2-9e94dc959caa", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman basilica exchange hall seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a long rectangular Roman forum basilica of dressed white marble and travertine, ringed by a colonnade of slender fluted columns, capped by a peaked terracotta-tiled roof with a low raised clerestory ridge running down its center, round-arched openings along the sides; under the open outer portico runs a row of money-changers' counters (tabernae argentariae) laid with neat stacks of gold coins, a small bronze balance scale, and a wooden counting abacus, with an iron-bound strongbox at one end; a golden coin-and-scales emblem set above the arched central entrance, standing on a small travertine-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (white and cream marble, travertine tan, terracotta-red roof tiles, muted crimson, gold coin accents), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  ...
  { key: "courthouses-basilica", id: "94969355-1c9f-4d4c-9d12-3101cc5b66db", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman basilica law court seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a rectangular civic justice hall of white marble and warm travertine stone with a low-pitched terracotta-tiled gable roof seen from above, a colonnaded portico of slender fluted marble columns wrapping the front and running down both long sides, a broad triangular pediment crowning the entrance carved in relief with a golden scales-of-justice emblem, a semicircular apse projecting from the far short end that shelters the raised magistrate's tribunal dais, a short flight of marble steps climbing to the columned entrance, the whole building set on a small stone-paved patch, a LIMITED FLAT palette of only a few solid colors (cream marble, warm travertine tan, terracotta roof tiles, deep shadow brown, gold emblem accent), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "bureau-tabularium", id: "cb14946e-662b-4513-8d83-9a9f8254d9bd", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman tabularium record office and clerical archive seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a compact rectangular civic building of dressed travertine and cream marble with a low terracotta tiled roof, a colonnaded portico of slender marble columns running along the front and one open side, and a small open inner court or atrium visible from above where rows of wooden pigeonhole shelves are packed with rolled papyrus scrolls and stacked wax writing tablets, a couple of clerks' writing desks with an open ledger, an inkpot and a red wax seal, a few scroll baskets and a stone bench set on the pale flagstone floor, a round-arched doorway and a small pediment over the entrance, standing on a neat stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, travertine tan, terracotta roof tiles, warm parchment scrolls, a touch of imperial red), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "think-stoa-roman", id: "f764ab8d-57c1-498d-8ea0-88c3f828dd84", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman philosophers covered colonnade portico (a stoa) seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a long rectangular covered walkway with a single straight row of tall pale marble columns along the open front supporting a low red terracotta tile lean-to roof clearly visible from above, a solid stone back wall behind the columns, a couple of low stone benches and one small marble statue on a pedestal set under the colonnade, a low stepped stone base, standing on a stone-paved patch, a clearly readable classical colonnade portico, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, terracotta roof, pale stone, shadow grey), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "archive-tabularium", id: "01ec4ae4-a517-4617-a269-5173b6cb7b5c", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman tabularium public records archive seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a rectangular travertine and marble record-hall with an open arcaded front gallery of round stone arches on squat pillars, a low-pitched terracotta tiled roof that is partly open to reveal the interior, inside rows of wooden pigeonhole shelving units (armaria) built into the walls and stacked full of rolled papyrus scrolls and small bronze document tablets, a couple of open scroll-buckets and a stone reading table on the polished flagstone floor, standing on a small stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream travertine marble, terracotta roof tiles, warm tan wood shelving, pale parchment scrolls, muted bronze), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "ruins-restoration-roman", id: "efa90bfb-f0a0-4345-93a4-b0b79b603e66", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman antiquarian restoration work-site seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a tall fluted white marble column being restored, wrapped in a light wooden scaffold of lashed poles and plank walkways, one fallen column drum and a cracked broken column shaft lying on the ground beside it, a fragment of a classical pediment and a carved Corinthian capital set out on the stone-paved patch, a few freshly cut travertine ashlar blocks and stacked marble drums waiting to be re-erected, a coil of rope, a wooden mallet and a bronze chisel resting on a block, a couple of small clay amphorae, all standing on a small stone-paved patch, clean simple pixel art with a LIMITED FLAT palette of only a few solid colors (cream marble, warm travertine, pale sandstone, weathered wood brown, a little bronze), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "watch-classical", id: "8f0321d1-f72b-4278-a882-d807b17fdfdb", shading: 'basic shading', quantize: 16, prompt: "a small ancient Roman watchtower and vigiles guard station seen from a high top-down angle looking down at it from above, completely deserted, no people, no figures, no person: a tall square multi-storey tower built of dressed cream travertine and pale marble ashlar blocks, each upper storey pierced by small round-arched window openings, a narrow round-arched doorway at the base, a projecting corbelled sentry balcony ringing the upper level, crowned by a low pyramidal roof of red terracotta tiles with a stone signal brazier beacon rising at the very top-center for fire-and-smoke signalling, a Roman vexillum standard on a pole beside the beacon, the tower rising from a small square stone-paved platform edged with a few short marble posts, a LIMITED FLAT palette of only a few solid colors (cream travertine, warm grey stone, terracotta-red roof tiles, dark bronze beacon, muted red standard), basic flat shading with very few color shades and no gradients, soft light from the upper-left casting shadows to the lower-right, transparent background" },
  { key: "sewers-classical", id: "066d573c-14f2-420b-8ebb-a878c35a794d", shading: "basic shading", quantize: 16, prompt: "a small clean ancient Roman stone waterworks and sewer drainage house seen from a high top-down angle, no people: compact pale travertine and dressed-stone building with a low red terracotta tiled roof, front pierced by a round Roman voussoir-stone archway closed by an IRON GRATE, a shallow paved stone channel of clear running water flowing out into a gutter, tidy masonry, clean with a little moss at the waterline, travertine cream and terracotta palette, basic flat shading, soft light upper-left, shadows lower-right, transparent background. v2 2026-07-13 (v1 = arche noire beante + mare verte, rejete)" },];
