...
export const chroniclePeriod5 = [
  ...
  // --- Crise (instability >= 0.75 || timeWear >= 0.75) ---
  {
    ...
    text: { fr: "« Les signes étaient là : entrepôts vides, colère haute, routes coupées. Le gouvernement promet d'étudier pourquoi il n'a rien étudié. »", en: "\"The signs were there: empty warehouses, high anger, severed roads. The government promises to study why it studied nothing.\"" },
    author: null
  },
  {
    id: "p5_crisis_riots",
