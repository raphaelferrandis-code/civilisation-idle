...
export const BOONS = [
  ...
  },
  {
    ...
    chronicle: (amt) => tr({ fr: `Les saisons nous sourient : les entrepôts débordent d'une récolte inespérée, +${amt} vivres.`, en: `The seasons smile upon us: the warehouses overflow with an unhoped-for harvest, +${amt} food.` })
  },
  {
    id: "discovery",
    resource: "knowledge",
