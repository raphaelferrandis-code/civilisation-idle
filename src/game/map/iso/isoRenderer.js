...
import { worldToScreen, visibleCellBounds, visibleDiamondBounds,  panDeltaToScreen, screenDeltaToPan,  ISO_X, ISO_Y } from './projection.js';
...
import { drawIsoBridgeUnder, drawIsoBridgeNight,  drawIsoBridgeSeg,  drawIsoBridges } from './isoBridge.js';
...
import {
   LAMP_TUNE, lampFootMetrics,  drawIsoMedians,
...
import { drawIsoAmbient, SMOKE_TUNE, smokeSeason, drawIsoSmoke,  drawIsoRevealPin } from './isoAmbient.js';
...
import {   drawIsoGroundedArt, ISO_TREE_VARIANTS} from './isoGroundProps.js';
// Le port fluvial (flotte legacy sur le ruban, quai, ponton), extrait le 2026-08-23.
import { drawIsoShips,  drawIsoPortBoat, drawIsoRiverside } from './isoPort.js';
...
import { drawIsoVehicle, drawIsoRioter, drawIsoCitizenItem, GHOST_TUNE} from './isoUnits.js';
...
import {
  ...
  AGENT_SCALE,                          // le reste du lot est parti avec isoUnits.js
} from '../agents.js';
