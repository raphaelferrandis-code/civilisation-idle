...
import { cityMapDrawQuays, updateCrisis, drawRiotWeapon, ensureQuayGate, quayWallTune } from '../quaysAndRiot.js';
...
import { BOAT_IMG_K, BOAT_IMG_TOP, tradeStage, tradeSizeMul, drawIsoBoatStub, drawIsoShipNight, shipVisual, riverDodge, boatSector, BOAT_ISO } from './isoFleet.js';
...
import { GRASS, GRASS_WILD, PLAZA, PLAZA_ERA_TONE, rgb } from './isoPalette.js';
...
import {
  ...
  ensureBoat, boatReady, BOAT_SIZES, BOAT_LIFT,   // ensureDrone/drawDroneRotors sont partis avec isoSky.js
