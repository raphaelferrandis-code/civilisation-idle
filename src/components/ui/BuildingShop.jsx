...
import { fmt, canPayCost } from '../../game/core/utils.js';
    ...
    <div className="panel shop-panel">
      ...
      <div className="shop-list shop-cat active">
        {visibleBuildings.map((b) => {
          ...
          const pulse = isAffordable && !firstAffordableSeen;
          if (pulse) firstAffordableSeen = true;
