...
export default function BuildingShop() {
  ...
  const babelActive = activeMythId === "mythe_de_babel";
          ...
          return (
            <article
              ...
              style={{
                ...
                '--work-fill': `${workFill}%`,
                '--milestone-alpha': String(Math.min(0.36, (milestoneInfo?.milestone || 0) * 0.045)),
                '--milestone-border': String(Math.min(0.92, 0.36 + (milestoneInfo?.milestone || 0) * 0.1)),
                '--milestone-glow': String(Math.min(0.34, (milestoneInfo?.milestone || 0) * 0.04))
              }}
            >
