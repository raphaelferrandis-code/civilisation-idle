...
const dogmaIds = new Set(PRESTIGE_DOGMAS.map((dogma) => dogma.id));

const PRESTIGE_TREE = PRESTIGE_TREE_BRANCHES.flatMap((branch) => branch.ids.map((id, index) => {
