...
|---|---|---|---|---|---|---|---|---|
| I | Le Mythe du Chaos | 1.46 | 1.27 | 1.00 | 1.00 | 1.00 | mult. | - |
...
| III | Le Mythe d'Icare | 5.00 | 2.97 | 1.00 | 1.00 | 1.00 | **GATE** | Bouton SURCHAUFFE : x5 production 30s, +25% Rupture, cd 2 min |
...
- **Effet passif mesure** : mult. global x1.46, production totale/s x1.27.
...
- **Effet passif mesure** : mult. global x5.00, production totale/s x2.97.
